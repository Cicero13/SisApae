...
<head>
	...
	<script>
			function validar(){
				if(confirm("Deseja Atualizar o Procedimento ?")){
					...
					<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading">
									<center><h3 class="panel-title">Alteração do Procedimento</h3></center>
									<br>
									<form name="f1" onsubmit="return validar();" method="POST" action="alterar.php">
										<div class="form-group">
											<label for="exampleInputEmail1">ID:</label>
											<input type="text" class="form-control" id="codproc" name="codproc" aria-describedby="emailHelp" placeholder="ID" value="<?php echo $linha['codproc'];?>" readonly="true" required="">
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Descrição:</label>
											<input type="text" class="form-control" id="descricao" name="descricao" aria-describedby="emailHelp" placeholder="Informe a Descrição" value="<?php echo $linha['descricao'];?>" required="">
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Número do Procedimento:</label>
											<input type="text" class="form-control" id="num_proc" name="num_proc" aria-describedby="emailHelp" placeholder="Informe o Nº do Procedimento" value="<?php echo $linha['num_proc'];?>" required="">
										</div>
