					...
					<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading">
									<center><h3 class="panel-title">Alteração de Profissional</h3></center>
									<br>
									<form name="f1" onsubmit="return validar();" method="POST" action="alterar.php">
										<div class="form-group">
											<label for="exampleInputEmail1">ID:</label>
											<input type="text" class="form-control" id="id" name="id" aria-describedby="emailHelp" placeholder="ID" value="<?php echo $linha['codprof'];?>" readonly="true" required="">
										</div>
										<div class="form-group">
                                    ...
                                    <select name="sexo" value="<?php echo $linha['sexo'];?>" id="sexo" class="form-control show-tick">
										...
										<div class="form-group">
											...
											<input type="text" value="<?php echo $linha['especialidade'];?>" class="form-control" id="especialidade" name="especialidade" placeholder="Informe sua Especialidade" required="">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Conselho:</label>
											<input type="text" class="form-control"value="<?php echo $linha['conselho'];?>" id="conselho" name="conselho" placeholder="Informe seu Conselho" required="">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">CBO:</label>
											<input type="text" class="form-control" value="<?php echo $linha['cbo'];?>" id="cbo" name="cbo" placeholder="Informe seu CBO" required="">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Fone:</label>
											<input type="text" value="<?php echo $linha['fone'];?>" class="form-control" id="fone" name="fone" placeholder="Informe seu Telefone" required="">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">CNS:</label>
											<input type="text" class="form-control" value="<?php echo $linha['cns'];?>" id="cns" name="cns" placeholder="Informe seu CNS" required="">
										</div>
								</div>
