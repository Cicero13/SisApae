			...
			<div class="main-content">
					...
					<div class="panel">
								<div class="panel-heading">
									<h1 class="panel-title">Relatório dos Atendimentos APAC</h1>
					...
					$("#modalimprime").on("click", "a", function(){
						...
						if(id2=='bnt_imprimir'){
							...
							$("#modalimprime").modal('hide'); 
						      var url = "reportapac.php?datai="+datai+"&dataf="+dataf+"&prof="+prof;
	...
	$("#mostrar").click(function() {
		...
		if(prof == 0){
			 $(function(){
				...
				$("#modalAguarde").modal('show'); //carregando o modal de processamento de notas
				$.post('buscapac.php', {d1: d1, d2: d2, prof: prof}, function(resposta) {
