													...
													while($linha = $consulta->fetch_array(MYSQLI_ASSOC)){
														...
														<tr>
															<td><?php echo $linha['nome'] ?></td>
																...
																<td><?php echo $linha['cbo'] ?></td>
																<td><?php echo $linha['fone'] ?></td>
																<td><?php echo $linha['cns'] ?></td>
															<td>
																<a title="Alterar" data-toggle="modal" data-target="#alterar<?php echo $linha['codprof'] ?>" class="btn btn-info" href="#">
																	<i class="fa fa-edit" style="color: white;"></i><span class="icon-name"></span>
																</a>
																<a title="Excluir" data-toggle="modal" data-target="#deletar<?php echo $linha['codprof'] ?>" class="btn btn-danger" href="#">
																	<i class="fa fa-trash" style="color: white;"></i><span class="icon-name"></span>
																</a>
																
																<div id="alterar<?php echo $linha['codprof']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
																	<div class="modal-dialog" role="document">
																		<div class="modal-content">
																			<form name="f1" method="POST" action="frmcadaltera.php">
																				 <input type="hidden" id="id" name="id" value="<?php echo $linha['codprof']; ?>">
																					<div class="modal-body">
																						<div>
																							<center><h3>Deseja alterar este Profissional?</h3></center>
																						</div>
																					</div>
																...
																<div id="deletar<?php echo $linha['codprof'];?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
																	<div class="modal-dialog" role="document">
																		<div class="modal-content">
																		<form name="f1" method="POST" action="delete.php">
																			<input type="hidden" id="id" name="id" value="<?php echo $linha['codprof']; ?>">
																				<div class="modal-body">
																					<div>
																						<center><h3>Deseja excluir este Profissional?</h3></center>
																					</div>
																				</div>
																		<div class="modal-footer">
																			<div class="center">
